...
class Connection {
	...
	protected function grammar()
	{
		...
		if (isset(\Neph\Core\DB::$registrar[$this->driver()]))
		{
			return $this->grammar = \Neph\Core\DB::$registrar[$this->driver()]['query']();
		}

		$grammar_class = Config::get('db/drivers/'.$this->driver(), '\\Neph\\Core\\DB\\'.$this->driver()).'\\Grammar';
