<?php namespace Neph\Core\DB\Query;

use Neph\Core\DB\Query;
use Neph\Core\DB\Expression;
...
class Grammar {
	...
	public function inflate($value, $type) {
		$method = 'inflate_'.$type;
	...
	public function inflate_datetime($value) {
		if (strpos($value, '0000') !== FALSE) return;
		return date_create_from_format($this->datetime, $value);
	}
